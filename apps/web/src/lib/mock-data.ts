...
export const MOCK_STAFF: StaffMemberRow[] = [
  { id: "sm-1", user_id: "u-1", restaurant_id: RID, role: "owner", is_primary: true, hourly_rate: null, employment_type: "full-time", created_at: daysAgo(365), user_profiles: { full_name: "Steven Georgy", email: "steven@cenaiva.ca", phone: "+1 514-555-9000", avatar_url: null } },
  { id: "sm-2", user_id: "u-2", restaurant_id: RID, role: "manager", is_primary: false, hourly_rate: 28.00, employment_type: "full-time", created_at: daysAgo(300), user_profiles: { full_name: "Camille Lavoie", email: "camille@cenaiva.ca", phone: "+1 514-555-9001", avatar_url: null } },
  { id: "sm-3", user_id: "u-3", restaurant_id: RID, role: "server", is_primary: false, hourly_rate: 16.50, employment_type: "full-time", created_at: daysAgo(200), user_profiles: { full_name: "Alex Nguyen", email: "alex.n@cenaiva.ca", phone: "+1 438-555-9002", avatar_url: null } },
  { id: "sm-4", user_id: "u-4", restaurant_id: RID, role: "server", is_primary: false, hourly_rate: 16.50, employment_type: "part-time", created_at: daysAgo(150), user_profiles: { full_name: "Jade Moreau", email: "jade.m@cenaiva.ca", phone: "+1 514-555-9003", avatar_url: null } },
  { id: "sm-5", user_id: "u-5", restaurant_id: RID, role: "host", is_primary: false, hourly_rate: 17.00, employment_type: "part-time", created_at: daysAgo(90), user_profiles: { full_name: "Ryan Ibrahim", email: "ryan.i@cenaiva.ca", phone: "+1 647-555-9004", avatar_url: null } },
  { id: "sm-6", user_id: "u-6", restaurant_id: RID, role: "kitchen", is_primary: false, hourly_rate: 22.00, employment_type: "full-time", created_at: daysAgo(250), user_profiles: { full_name: "Marco Bianchi", email: "marco.b@cenaiva.ca", phone: "+1 514-555-9005", avatar_url: null } },
  { id: "sm-7", user_id: "u-7", restaurant_id: RID, role: "bar", is_primary: false, hourly_rate: 18.00, employment_type: "full-time", created_at: daysAgo(180), user_profiles: { full_name: "Léa Gagnon", email: "lea.g@cenaiva.ca", phone: "+1 438-555-9006", avatar_url: null } },
];

// ─── Expenses ───────────────────────────────────────────────────
export const MOCK_EXPENSES: ExpenseRow[] = [
  { id: "exp-1", restaurant_id: RID, transaction_type: "expense", category: "food_supplies", vendor_name: "Sysco", description: "Weekly produce & meat delivery", notes: null, amount: 2840.00, tax_amount: 426.00, total_amount: 3266.00, currency: "cad", expense_date: daysAgo(1), receipt_url: null, receipt_type: null, ai_categorized: false, created_at: daysAgo(1), deleted_at: null },
  { id: "exp-2", restaurant_id: RID, transaction_type: "expense", category: "beverages", vendor_name: "SAQ", description: "Wine restock — Côtes du Rhône, Chablis", notes: null, amount: 1450.00, tax_amount: 217.50, total_amount: 1667.50, currency: "cad", expense_date: daysAgo(2), receipt_url: null, receipt_type: null, ai_categorized: true, created_at: daysAgo(2), deleted_at: null },
  { id: "inc-1", restaurant_id: RID, transaction_type: "income", category: "events", vendor_name: "Chef's Table tickets", description: "Private tasting ticket sales", notes: null, amount: 2400.00, tax_amount: 312.00, total_amount: 2712.00, currency: "cad", expense_date: daysAgo(2), payment_status: "paid", paid_at: daysAgo(2), receipt_url: null, receipt_type: null, ai_categorized: false, created_at: daysAgo(2), deleted_at: null },
  { id: "exp-3", restaurant_id: RID, transaction_type: "expense", category: "equipment", vendor_name: "Restaurant Depot", description: "2x bus tubs, 1x heat lamp", notes: null, amount: 189.00, tax_amount: 28.35, total_amount: 217.35, currency: "cad", expense_date: daysAgo(3), receipt_url: null, receipt_type: null, ai_categorized: false, created_at: daysAgo(3), deleted_at: null },
  { id: "exp-4", restaurant_id: RID, transaction_type: "expense", category: "utilities", vendor_name: "Hydro-Québec", description: "March electricity bill", notes: null, amount: 680.00, tax_amount: 0, total_amount: 680.00, currency: "cad", expense_date: daysAgo(5), receipt_url: null, receipt_type: null, ai_categorized: false, created_at: daysAgo(5), deleted_at: null },
  { id: "exp-5", restaurant_id: RID, transaction_type: "expense", category: "marketing", vendor_name: "Meta Ads", description: "Instagram campaign — March", notes: null, amount: 350.00, tax_amount: 52.50, total_amount: 402.50, currency: "cad", expense_date: daysAgo(7), receipt_url: null, receipt_type: null, ai_categorized: true, created_at: daysAgo(7), deleted_at: null },
  { id: "exp-6", restaurant_id: RID, transaction_type: "expense", category: "cleaning", vendor_name: "CleanCo", description: "Deep cleaning service", notes: null, amount: 420.00, tax_amount: 63.00, total_amount: 483.00, currency: "cad", expense_date: daysAgo(8), receipt_url: null, receipt_type: null, ai_categorized: false, created_at: daysAgo(8), deleted_at: null },
];
