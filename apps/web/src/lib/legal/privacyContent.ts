...
export const PRIVACY_SECTIONS: LegalSection[] = [
  ...
  },
  {
    ...
    body: "When you delete your account at Profile → Privacy → Delete Account, we soft-delete your auth record, detach saved payment methods at Stripe, cancel any active subscriptions, and remove or scrub your personal data across reservations, visits, chats, orders, surveys, Snaps, and other linked records.\n\nUnredeemed in-app rewards and any prepaid wallet balance are forfeited at deletion. We recommend you withdraw or use any remaining balance first if you want to keep it. Booking history, conversation history, and personal data cannot be restored after deletion.\n\nInformation we are required to retain by law (for example, tax and payments records) is preserved for the minimum period required and is not used for any other purpose.\n\nAccount merges. If you sign in using two different methods that we determine belong to the same person (for example, an email and a phone number), we may offer to merge the accounts. A minimal audit record of any merge is retained for fraud prevention.",
  },
  {
    id: "security",
    number: "12",
