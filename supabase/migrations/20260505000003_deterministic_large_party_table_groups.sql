-- Use deterministic row ordering for large-party table combinations.
-- UUID text ordering can skip valid adjacent combinations when a large party
-- needs most or all available tables in a section.
