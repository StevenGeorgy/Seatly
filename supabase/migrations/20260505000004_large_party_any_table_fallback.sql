-- Large parties should be bookable up to saved floor capacity.
-- Prefer a single table first, then adjacent same-section groups, then fall back
-- to the smallest available table set that can physically seat the party.
